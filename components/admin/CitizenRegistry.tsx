...
export default function CitizenRegistry() {
  ...
  const citizens = [
    { id: "C-101", name: "Juan Dela Cruz", barangay: "San Jose", violations: 0, joined: "May 2025", email: "juan.dc@email.com" },
    { id: "C-102", name: "Elena Ramos", barangay: "Sto. Niño", violations: 2, joined: "Aug 2025", email: "elena.r@email.com" },
    { id: "C-103", name: "Mateo Silva", barangay: "Santa Maria", violations: 1, joined: "Jan 2026", email: "mateo.s@email.com" },
    { id: "C-104", name: "Ricardo Cruz", barangay: "San Jose", violations: 3, joined: "Nov 2025", email: "rcruz@email.com" },
  ];
          ...
          <div className="relative w-full max-w-lg bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-full sm:slide-in-from-bottom-4 duration-500 ease-out">
            ...
            <div className="p-6 md:p-8">
              <div className="flex justify-between items-start mb-6">
                ...
                <button onClick={() => setSelectedCitizen(null)} className="p-2 bg-slate-50 text-slate-400 hover:text-slate-900 rounded-lg transition-colors">✕</button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-slate-50 rounded-xl border border-slate-100 flex justify-between items-center group">
                  <div>
                    <p className="text-[9px] font-black text-slate-400 uppercase mb-1 tracking-widest">Email</p>
                    <p className="text-xs font-bold text-slate-800">{selectedCitizen.email}</p>
                  </div>
                  <span className="text-lg">✉️</span>
                </div>

                <div className={`p-5 rounded-xl border ${selectedCitizen.violations > 0 ? "bg-red-50 border-red-100" : "bg-emerald-50 border-emerald-100"}`}>
                ...
                <button 
                  className="w-full py-4 bg-slate-900 text-white rounded-xl font-black text-[10px] tracking-[0.2em] uppercase shadow-lg hover:bg-emerald-600 transition-all active:scale-95"
