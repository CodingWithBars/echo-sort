  ...
  const violations = [
    {
      ...
      description:
        "Mixed biodegradable with plastic recyclables. Second warning for this household.",
    ...
    },
    {
      ...
      description:
        "Trash bins left out 4 hours after the truck passed. Resident informed of schedule.",
    ...
    },
    {
      ...
      description:
        "Commercial waste dumped at a residential collection point. Identifying vehicle plate.",
    ...
    <div className="space-y-6 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        {filteredViolations.map((v) => (
          ...
          >
            <div
              className={`h-1.5 w-full ${getStatusColor(v.status).split(" ")[0]}`}
            />
            ...
            <div className="p-5 flex flex-col h-full">
              ...
              <div className="mt-auto flex justify-between items-center">
                ...
                <div className="w-8 h-8 rounded-lg bg-slate-50 flex items-center justify-center text-xs group-hover:bg-red-50 group-hover:text-red-600 transition-colors">
                  ⚠️
                </div>
              </div>
            </div>
      ...
      {selectedViolation && (
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-0 sm:p-4">
          ...
          <div className="relative w-full max-w-lg bg-white rounded-t-2xl sm:rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-full sm:slide-in-from-bottom-4 duration-500">
            <div
              className={`h-1.5 w-full ${getStatusColor(selectedViolation.status).split(" ")[0]}`}
            />
            ...
            <div className="p-6 md:p-8">
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                    {selectedViolation.id} • {selectedViolation.date}
                  </p>
                </div>
                <button
                  onClick={() => setSelectedViolation(null)}
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 bg-red-50/50 rounded-xl border border-red-100 flex justify-between items-center">
                  <div>
                    <p className="text-[9px] font-black text-red-700 uppercase mb-1">
                      Primary Subject
                    </p>
